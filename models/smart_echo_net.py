...
class SMART_ECHO_NET(nn.Module):
    """
    Compound Smart Echo Net, starting with Conv1Ds with kernel_size=1
...
def smart_echo_net(pretrained=False, **kwargs):
    """
    Constructs a SMART_ECHO_NET model.
    """
    assert not pretrained
    return SMART_ECHO_NET(**kwargs)
